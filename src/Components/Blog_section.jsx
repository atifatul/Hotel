        ...
        <div className="container">
            ...
            <div className="row g-4 mb-40">
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="blog-card2 three">
                        ...
                        <div className="blog-content">
                            <a href="travel-inspiration-01.html" className="batch">Holiday Tips</a>
                            <h4><a href="travel-inspiration-details.html">10 Breathtaking Destinations You Need to Visit This Year.</a></h4>
                            <ul className="blog-meta">
                                <li><a href="travel-inspiration-01.html">05 March, 2025</a></li>
                                <li>4 min read</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div className="blog-card2 three">
                        ...
                        <div className="blog-content">
                            <a href="travel-inspiration-01.html" className="batch">Vacation Destination </a>
                            <h4><a href="travel-inspiration-details.html">Top 5 All-Inclusive Resorts Worth Every Penny.</a></h4>
                            <ul className="blog-meta">
                                <li><a href="travel-inspiration-01.html">12 March, 2025</a></li>
                                <li>2 min read</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div className="blog-card2 three">
                        ...
                        <div className="blog-content">
                            <a href="travel-inspiration-01.html" className="batch">Activities</a>
                            <h4><a href="travel-inspiration-details.html">Scuba Diving vs. Snorkeling Which One Should You Try?</a></h4>
                            <ul className="blog-meta">
                                <li><a href="travel-inspiration-01.html">15 March, 2025</a></li>
                                <li>5 min read</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="row wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div className="col-lg-12 d-flex justify-content-center">
                    <a href="travel-inspiration-01.html" className="primary-btn1 two three transparent">
                        <span>
