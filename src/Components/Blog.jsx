          ...
          <div className="row gy-lg-5 gy-4">
            ...
            >
              <div className="package-card two">
                ...
                <div className="package-content">
                  <h5>
                    <a href="experience-details.html">Zip-lining & Canopy</a>
                  </h5>
                      ...
                      <li>
                        ...
                        <div className="info">
                          ...
                          <div className="tooltip-text">
                            This package covers{" "}
                            <span>
                              Accommodation, Daily Meals, Entry Fees & Local
                              Transfers
                            </span>{" "}
                  ...
                  <div className="swiper package-card-img-slider">
                    <div className="swiper-wrapper">
                      ...
                      <div className="swiper-slide">
                        ...
                        >
                          <img
                            src="assets/img/home6/tour-package-img3.jpg"
                            alt=""
                          />
                        </a>
                      </div>
                      <div className="swiper-slide">
                        ...
                        >
                          <img
                            src="assets/img/home6/tour-package-img4.jpg"
                            alt=""
                          />
                        </a>
                      </div>
            ...
            >
              <div className="package-card two">
                  ...
                  <div className="swiper package-card-img-slider">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        ...
                        >
                          <img
                            src="assets/img/home6/tour-package-img6.jpg"
                            alt=""
                          />
                        </a>
                      </div>
                      <div className="swiper-slide">
                        ...
                        >
                          <img
                            src="assets/img/home6/tour-package-img7.jpg"
                            alt=""
                          />
                        </a>
                      </div>
                      <div className="swiper-slide">
                        ...
                        >
                          <img
                            src="assets/img/home6/tour-package-img8.jpg"
                            alt=""
                          />
                        </a>
                      </div>
                ...
                <div className="package-content">
                  <h5>
                    <a href="experience-details.html">Surfing & Waterfalls</a>
                  </h5>
                  <div className="location-and-time">
                    <div className="location">
                      <svg
            ...
            >
              <div className="package-card two">
                ...
                <div className="package-content">
                  <h5>
                    <a href="experience-details.html">Mountain Rock Climbing</a>
                  </h5>
                  <div className="location-and-time">
                    <div className="location">
                      <svg
            ...
            >
              <div className="package-card two">
                  ...
                  <div className="swiper package-card-img-slider">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        ...
                        >
                          <img
                            src="assets/img/home6/tour-package-img10.jpg"
                            alt=""
                          />
                        </a>
                      </div>
                      <div className="swiper-slide">
                        ...
                        >
                          <img
                            src="assets/img/home6/tour-package-img11.jpg"
                            alt=""
                          />
                        </a>
                      </div>
                      <div className="swiper-slide">
                        ...
                        >
                          <img
                            src="assets/img/home6/tour-package-img12.jpg"
                            alt=""
                          />
                        </a>
                      </div>
                ...
                <div className="package-content">
                  <h5>
                    <a href="experience-details.html">Verdon Gorge France</a>
                  </h5>
                  <div className="location-and-time">
                    <div className="location">
                      <svg
