...
const Home1travel_package = () => {
  ...
  useEffect(() => {
    const url = "http://localhost/crm/API/topdestination.php"; // Same API
    // const requestBody = {
              ...
              >
                ...
                <div className="package-card two">
                  <div className="package-img-wrap">
                    <Link
                      to={`/Explore-Tours?destination=${pkg.name}`}
                      className="package-img"
                    >
                      <img
                        src={
                          pkg.photo && !pkg.photo.endsWith("/")
                            ? pkg.photo
                  ...
                  <div className="package-content">
                    <h5>
                      <Link to={`/Explore-Tours?destination=${pkg.name}`}>
                        {pkg.name}
                      </Link>
                    </h5>
