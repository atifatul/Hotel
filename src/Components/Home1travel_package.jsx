...
const Home1travel_package = () => {
  ...
  useEffect(() => {
    const url = "http://localhost/crm/API/packagelist.php"; // Same API
    const requestBody = {
    ...
    axios
      ...
      .then((response) => {
        const allPackagesData = response.data.Package || [];
        // Randomly select 8 packages
        let shuffledData = [...allPackagesData];
        ...
        const selectedPackages = shuffledData.slice(0, 6); // Displaying 6 packages for 2 rows of 3
        setPackages(selectedPackages);
      })
      .catch((err) => {
        console.error("Error fetching package list:", err);
        setError("Failed to fetch popular destinations.");
      })
      .finally(() => {
        setLoading(false);
      });
  ...
  if (loading) {
    return (
      <div className="home6-travel-package-section mb-60">
  ...
  if (error) {
    return (
      <div className="home6-travel-package-section mb-60">
        <div className="container text-center py-5" style={{ color: "red" }}>
          <p>{error}</p>
        </div>
      </div>
    );
    ...
    <>
      <div className="home6-travel-package-section mb-60">
        <div className="container">
          ...
          >
            <div className="col-xl-6 col-lg-8">
              <div className="section-title text-center">
                ...
                <p>
                  A curated list of the most popular travels based on different
                  destinations.
                </p>
              </div>
            </div>
          ...
          {/* Package Cards Grid - 3 cards per row on large screens */}
          <div className="row gy-lg-5 gy-4">
            {packages.map((pkg, index) => (
              ...
              <div
                ...
                data-wow-duration="1500ms"
              >
                {/* *** Using package-card two style (Original) *** */}
                <div className="package-card two">
                  <div className="package-img-wrap">
                    ...
                    >
                      <img
                        src={
                          pkg.banner && !pkg.banner.endsWith("/")
                            ? pkg.banner
                            : "assets/img/home6/tour-package-img1.jpg" // Default image (adjust path if needed)
                        }
                        alt={pkg.name}
                        style={{ height: "250px", objectFit: "cover" }} // Adjust height if needed
                      />
                    </Link>
                    {/* Add batch if needed */}
                  </div>
                  <div className="package-content">
                    <h5>
                      <Link to={`/insideTour/${pkg.packageId}`}>
                        {pkg.name}
                      </Link>
                    </h5>
                    {/* Location/Time - Commented out as in original code
                       <div className="location-and-time"> ... </div>
                    */}
                    <div className="btn-and-price-area">
                      <Link
                        to={`/insideTour/${pkg.packageId}`}
                        className="primary-btn1 three" // Using 'three' as in original
                      >
                        <span>
                          Book Now
                          <svg
                      ...
                      <div className="price-area">
                        {/* <h6>Per Person</h6> */}
                        {/* Display price or fallback text */}
                        {/* <span>{pkg.price ? `₹${pkg.price}` : "N/A"}</span> */}
                      </div>
                    </div>

                    {/* *** Tooltip Structure (Original) *** */}
                    <svg
                      className="divider"
                      height="6"
                      viewBox="0 0 374 6"
                    ...
                    <div className="bottom-area">
                      <ul>
                        <li>
                          {/* Experience Tooltip (Static Text) */}
                          <svg
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
                        ...
                        <li>
                          {/* Inclusion Tooltip (Dynamic Text) */}
                          <svg
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
                          ...
                          <div className="info">
                            ...
                            <div className="tooltip-text">
                              ...
                              This package covers
                              <span>
                                {pkg.inclusion && pkg.inclusion.trim() !== ""
        ...
        <div className="container">
          <div className="refund-wrap">
            <div className="refund-content">
              <h4>
                For only <span>Medical Purpose</span> you can get refund
              </h4>
              <ul>
                <li>
                  <svg
                ...
                <li>
                  ...
                  <div className="content">
                    <span>Pregnancy-Related Complications –</span> If a doctor
                    advises against travel due to health risks associated with
                    pregnancy.
                  </div>
                </li>
            ...
            <div className="refund-img">
              <img src="assets/img/home6/home6-refund-img.png" alt="" />
            </div>
          </div>
        </div>
        <img
...
export default Home1travel_package;
