...
const Home1travel_package = () => {
  return (
            ...
            <div className="row gy-lg-5 gy-4">
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="package-card two">
                        <div className="package-img-wrap">
                            <a href="experience-details.html" className="package-img">
                                <img src="assets/img/home6/tour-package-img1.jpg" alt=""/>
                            </a>
                            <div className="batch">
                                <span>Sale on!</span>
                            </div>
                        ...
                        <div className="package-content">
                            <h5><a href="experience-details.html">Zip-lining & Canopy</a></h5>
                            <div className="location-and-time">
                                <div className="location">
                                    ...
                                    <a href="experience-grid.html">Himachal Pradesh, India</a>
                                </div>
                            ...
                            <div className="btn-and-price-area">
                                <a href="experience-details.html" className="primary-btn1 three">
                                    <span>
                                        Book Now
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div className="package-card two">
                            ...
                            <div className="swiper package-card-img-slider">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <a href="experience-details.html" className="package-img">
                                            <img src="assets/img/home6/tour-package-img2.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="experience-details.html" className="package-img">
                                            <img src="assets/img/home6/tour-package-img3.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="experience-details.html" className="package-img">
                                            <img src="assets/img/home6/tour-package-img4.jpg" alt=""/>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="package-content">
                            <h5><a href="experience-details.html">Snowboarding & Ice Thrills</a></h5>
                            <div className="location-and-time">
                                <div className="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <a href="experience-grid.html">Maldives</a>
                                </div>
                                <svg className="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"/>
                                </svg>
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div className="package-card two">
                        <div className="package-img-wrap">
                            <a href="experience-details.html" className="package-img">
                                <img src="assets/img/home6/tour-package-img5.jpg" alt=""/>
                            </a>
                            <div className="batch">
                                <span className="yellow-bg">Family Tour</span>
                            </div>
                        </div>
                        <div className="package-content">
                            <h5><a href="experience-details.html">Skydiving & Paragliding</a></h5>
                            <div className="location-and-time">
                                <div className="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <a href="experience-grid.html">Nepal</a>
                                </div>
                                <svg className="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"/>
                                </svg>
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div className="package-card two">
                        <div className="package-img-wrap">
                            <div className="swiper package-card-img-slider">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <a href="experience-details.html" className="package-img">
                                            <img src="assets/img/home6/tour-package-img6.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="experience-details.html" className="package-img">
                                            <img src="assets/img/home6/tour-package-img7.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="experience-details.html" className="package-img">
                                            <img src="assets/img/home6/tour-package-img8.jpg" alt=""/>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="package-content">
                            <h5><a href="experience-details.html">Surfing & Waterfalls</a></h5>
                            <div className="location-and-time">
                                <div className="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <a href="experience-grid.html">Goa, India</a>
                                </div>
                                <svg className="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"/>
                                </svg>
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div className="package-card two">
                        <div className="package-img-wrap">
                            <a href="experience-details.html" className="package-img">
                                <img src="assets/img/home6/tour-package-img9.jpg" alt=""/>
                            </a>
                            <div className="batch">
                                <span className="yellow-bg">Group Tour</span>
                            </div>
                        ...
                        <div className="package-content">
                            <h5><a href="experience-details.html">Mountain Rock Climbing</a></h5>
                            <div className="location-and-time">
                                <div className="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <a href="experience-grid.html">Switzerland,</a>
                                    <a href="experience-grid.html">Nepal</a>
                                </div>
                                <svg className="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"/>
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div className="package-card two">
                        <div className="package-img-wrap">
                            <div className="swiper package-card-img-slider">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <a href="experience-details.html" className="package-img">
                                            <img src="assets/img/home6/tour-package-img10.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="experience-details.html" className="package-img">
                                            <img src="assets/img/home6/tour-package-img11.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="experience-details.html" className="package-img">
                                            <img src="assets/img/home6/tour-package-img12.jpg" alt=""/>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="package-content">
                            <h5><a href="experience-details.html">Verdon Gorge France</a></h5>
                            <div className="location-and-time">
                                <div className="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <a href="experience-grid.html">France</a>
                                </div>
                                <svg className="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"/>
                                </svg>
    ...
    <div className="refund-area two mb-100 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
        <div className="container">
            <div className="refund-wrap">
                <div className="refund-content">
                    <h4>For only <span>Medical Purpose</span> you can get refund</h4>
                    <ul>
                        <li>
                            ...
                            <div className="content">
                                <span>Severe Illness or Injury –</span> A serious health condition that prevents travel, confirmed by a medical certificate.
                            </div>
                        </li>
                        <li>
                            <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="content">
                                <span>Pregnancy-Related Complications –</span> If a doctor advises against travel due to health risks associated with pregnancy.
                            </div>
                        </li>
                        <li>
                            <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="content">
                                <span>All regal/proof documents you could submit our GoFly agency.</span>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <img src="assets/img/home6/vector/refund-area-vector.svg" alt="" className="vector1"/>
    </div>
    </>
  );
};
