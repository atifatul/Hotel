  ...
  return (
    <>
      <div className="home6-offer-banner-section mb-100">
        <div className="swiper home6-offer-banner-slider">
          <div className="swiper-wrapper">
            <div className="swiper-slide">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(180deg, rgba(0, 0, 0, 0) 74.86%, rgba(0, 0, 0, 0.8) 100%), url('assets/img/home6/home6-offer-banner-img1.jpg')",
                }}
              >
            ...
            <div className="swiper-slide">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(180deg, rgba(0, 0, 0, 0) 74.86%, rgba(0, 0, 0, 0.8) 100%), url('assets/img/home6/home6-offer-banner-img2.jpg')",
                }}
              >
                <div className="container">
                  <div className="row justify-content-center">
            ...
            <div className="swiper-slide">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(180deg, rgba(0, 0, 0, 0) 74.86%, rgba(0, 0, 0, 0.8) 100%), url('assets/img/home6/home6-offer-banner-img3.jpg')",
                }}
              >
                <div className="container">
                  <div className="row justify-content-center">
        ...
        <div className="btn-and-img-area">
          <div className="container">
            <div className="slider-btn-grp">
              <div className="slider-btn offer-banner-slider-prev">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                ...
                >
                  <g>
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M0 7.31421H16V8.68564H0V7.31421Z"
                    />
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
              ...
              <div className="swiper home6-offer-sm-img-slider">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="offer-sm-img">
                      <img
                        src="assets/img/home6/home6-offer-sm-img1.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="offer-sm-img">
                      <img
                        src="assets/img/home6/home6-offer-sm-img2.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="offer-sm-img">
                      <img
                        src="assets/img/home6/home6-offer-sm-img3.jpg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div className="slider-btn offer-banner-slider-next">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
...
export default Home1OfferBanner_section;
