...
const Home1destination_section = () => {
  return (
            ...
            <div className="row g-xl-4 g-md-3 g-4">
                <div className="col-md-4 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="destination-card3">
                        <img src="assets/img/home6/destination-img1.jpg" alt=""/>
                        <div className="destination-content">
                            <h2><a href="destination-details.html">Rome</a></h2>
                ...
                <div className="col-md-4">
                    <div className="destination-card3 sm-card mb-20">
                        <img src="assets/img/home6/destination-img2.jpg" alt=""/>
                        <div className="destination-content">
                            <h2><a href="destination-details.html">Thailand</a></h2>
                            <span>12 Activities</span>
                        </div>
                    </div>
                    <div className="destination-card3 sm-card">
                        <img src="assets/img/home6/destination-img3.jpg" alt=""/>
                        <div className="destination-content">
                            <h2><a href="destination-details.html">Maldives</a></h2>
                 ...
                 <div className="col-md-4 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="destination-card3">
                        <img src="assets/img/home6/destination-img4.jpg" alt=""/>
                        <div className="destination-content">
                            <h2><a href="destination-details.html">Indonesia</a></h2>
    ...
    <div className="home6-service-section mb-100">
            ...
            <div className="service-wrapper five">
                <div className="row justify-content-center wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="col-lg-9">
                        <div className="section-title">
                            <h2>We’re commited Our Traveler <span>to provide best services.</span></h2>
                        </div>
                    </div>
                </div>
                ...
                <div className="bottom-area d-flex justify-content-center wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="batch">
                        ...
                        <a href="contact.html">Customize Package
        ...
        <img src="assets/img/home6/vector/service-section-vector1.svg" alt="" className="vector1"/>
        <img src="assets/img/home6/vector/service-section-vector2.svg" alt="" className="vector2"/>
    </div>
    </>
  );
};
