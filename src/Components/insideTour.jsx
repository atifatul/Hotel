const InsideTour = () => {
  return (
    <>
          ...
          <div className="details-breadcrumb-bottom-wrapper">
            <div className="left-content">
              ...
              <a href="https://www.tripadvisor.com/" className="rating-area">
                <img
                  src="assets/img/innerpages/icon/tripadvisor-rating.svg"
                  alt=""
                />
                <strong>(4.5/5)</strong>
            ...
            <div className="right-content">
              <span>
                <img src="assets/img/innerpages/icon/carbon-icon.svg" alt="" />
                100% Carbon Neutral
              </span>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-header">
              <h4 className="modal-title" id="packageLocationModalLabel">
                Eiffel Tower, France : 02 Days
              </h4>
            </div>
            <div className="modal-body">
              <ul className="nav nav-pills" id="pills-tab" role="tablist">
                ...
                <li className="nav-item" role="presentation">
                  <button
                    className="nav-link"
                    id="pills-accommodation-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#pills-accommodation"
                    type="button"
                    role="tab"
                    ...
                    <div className="row g-4">
                      <div className="col-md-4 col-sm-6">
                        <div className="activity-card">
                          <div className="activity-img">
                            <img
                              src="assets/img/innerpages/location-modal-activity-img1.jpg"
                              alt=""
                            />
                          </div>
                          <div className="activity-content">
                            ...
                            <p>
                              The Eiffel Tower, one of the most iconic landmarks
                              in the world, offers an incredible climbing
                              experience seekers and travelers.
                            </p>
                            <a href="#">
                              Read More
                      ...
                      <div className="col-md-4 col-sm-6">
                        <div className="activity-card">
                          <div className="activity-img">
                            <img
                              src="assets/img/innerpages/location-modal-activity-img2.jpg"
                              alt=""
                            />
                          </div>
                          <div className="activity-content">
                            ...
                            <p>
                              The Eiffel Tower at sunset and night offers one of
                      ...
                      <div className="col-md-4 col-sm-6">
                        <div className="activity-card">
                          <div className="activity-img">
                            <img
                              src="assets/img/innerpages/location-modal-activity-img3.jpg"
                              alt=""
                            />
                          </div>
                          <div className="activity-content">
                            <h6>Bike Tour</h6>
                            <p>
                              Ride through the city's charming streets, soak in
                              the beauty of iconic landmarks, and enjoy an
                              active and eco-friendly adventure.
                            </p>
                            <a href="#">
                              Read More
                              <i className="bi bi-caret-down-fill"></i>
                    ...
                    <div className="row g-4">
                      <div className="col-md-4 col-sm-6">
                        <div className="activity-card">
                          <div className="activity-img">
                            <img
                              src="assets/img/innerpages/location-modal-activity-img4.jpg"
                              alt=""
                            />
                          </div>
                          <div className="activity-content">
                            ...
                            <p>
                              From sunrise to sunset to sparkling nightscapes,
                              the Eiffel Tower’s 360° views will leave you
                              speechless.
                            </p>
                            <a href="#">
                              Read More
                      ...
                      <div className="col-md-4 col-sm-6">
                        <div className="activity-card">
                          <div className="activity-img">
                            <img
                              src="assets/img/innerpages/location-modal-activity-img5.jpg"
                              alt=""
                            />
                          </div>
                          <div className="activity-content">
                            ...
                            <p>
                              Imagine sipping a glass of fine champagne while
                  ...
                  <div className="content-wrapper">
                    <div className="accommodation-wrap">
                      <div className="accommodation-img">
                        <img
                          src="assets/img/innerpages/location-modal-accommodation-img.jpg"
                          alt=""
                        />
                      </div>
                      <div className="accommodation-content">
                        ...
                        <p>
                          Whether you're visiting Paris for a romantic getaway,
                          an adventure, or a luxury vacation, finding the right
                          accommodation with excellent facilities enhances your
                          experience.
                        </p>
                        <ul>
                          <li>
                  ...
                  <div className="content-wrapper">
                    <div className="transport-wrap">
                      <div className="title-area">
                        ...
                        <span>
                          <strong>Paris Metro</strong> (Subway)
                        </span>
                      </div>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          16 metro lines & 300+ stations covering all major
                          attractions.
                        </li>
                        <li>
                          <svg
      ...
      {/* Location Details Modal section ends here */}

      {/* Rating modal section starts here*/}
      <div
      ...
      {/* Rating modal section ends here*/}

      {/* Booking Modal section start here  */}
      <div
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-header">
              ...
              <p>
                Select your travel date & time, also minium traveller for reason
                easily booking a package.
              </p>
            </div>
            <div className="modal-body">
              <form>
                ...
                <div
                  id="tour-booking-calendar"
                  className="calendar-wrapper full-date two"
                  ...
                  data-start-date="hotel-details-checkin"
                  data-end-date="hotel-details-checkout"
                >
                  <div className="calendar-inner">
                    ...
                    <div className="calendar-actions">
                      <a
                        href="#"
                        id="tour-calendar-check"
                        className="calendar-check underline"
                      >
                        Apply
                      </a>
                    </div>
              ...
              <div className="package-list">
                <div
                  ...
                  id="accordionFlushPackage"
                >
                  <div className="accordion-item">
                    <div
                      className="accordion-header"
                      id="flush-package-headingOne"
                    >
                      <div
                        className="accordion-button"
                        role="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#flush-package-collapseOne"
                        aria-expanded="false"
                    ...
                    <div
                      id="flush-package-collapseOne"
                      className="accordion-collapse collapse show"
                      aria-labelledby="flush-package-headingOne"
                      data-bs-parent="#accordionFlushPackage"
                    >
                      <div className="accordion-body">
                        <div className="tour-info-and-calculate-area">
                          <p>
                            An 11-night journey covering Bangkok{" "}
                            <i className="bi bi-arrow-right"></i>
                            River Kwai <i className="bi bi-arrow-right"></i>{" "}
                            Chiang Rai <i className="bi bi-arrow-right"></i>{" "}
                            Chiang Mai <i className="bi bi-arrow-right"></i> Phi
                            Phi <i className="bi bi-arrow-right"></i> Phuket.
                          </p>
                          <div className="price-calculate">
                            <span className="adult">
                              $30 <i className="bi bi-x"></i> 2 Adult
                            </span>
                            <span className="children">
                              $25 <i className="bi bi-x"></i> 1 Children
                            </span>
                          </div>
                        </div>
                            ...
                            <li>
                              <div className="service-info-wrap">
                                ...
                                <div className="service-info">
                                  ...
                                  <p>
                                    Offer professional photo packages or digital
                                    keepsakes of key moments on the tour.
                                  </p>
                                </div>
                              </div>
                  ...
                  <div className="accordion-item">
                    <div
                      className="accordion-header"
                      id="flush-package-headingTwo"
                    >
                      <div
                        className="accordion-button collapsed"
                        role="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#flush-package-collapseTwo"
                        aria-expanded="false"
                      ...
                      >
                        ...
                        <div className="title-area">
                          <span className="check"></span>
                          <h6>Jordan classNameic Tour.</h6>
                        </div>
                        <span>$39.00 </span>
                      </div>
                    </div>
                    <div
                      id="flush-package-collapseTwo"
                      className="accordion-collapse collapse"
                      aria-labelledby="flush-package-headingTwo"
                      data-bs-parent="#accordionFlushPackage"
                    >
                      <div className="accordion-body">
                        <div className="tour-info-and-calculate-area">
                  ...
                  <div className="accordion-item">
                    <div
                      className="accordion-header"
                      id="flush-package-headingThree"
                    >
                      <div
                        className="accordion-button collapsed"
                        role="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#flush-package-collapseThree"
                        aria-expanded="false"
                    ...
                    <div
                      id="flush-package-collapseThree"
                      className="accordion-collapse collapse"
              ...
              <div className="package-details-warpper">
                <div className="package-info-wrap mb-60">
                  ...
                  <p>
                    ...
                    region offer a perfect blend of history, culture, luxury,
                    and romance. Whether you’re exploring iconic landmarks,
                    indulging in French cuisine, or enjoying the charming
                    countryside, this region has something for every traveler.
                  </p>
                      ...
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="location-card">
                            ...
                            >
                              <img
                                src="assets/img/innerpages/package-dt-location-img1.jpg"
                                alt=""
                              />
                            </a>
                        ...
                        <div className="swiper-slide">
                          <div className="location-card">
                            ...
                            >
                              <img
                                src="assets/img/innerpages/package-dt-location-img2.jpg"
                                alt=""
                              />
                            </a>
                            <div className="location-content">
                        ...
                        <div className="swiper-slide">
                          <div className="location-card">
                            ...
                            >
                              <img
                                src="assets/img/innerpages/package-dt-location-img3.jpg"
                                alt=""
                              />
                            </a>
                            <div className="location-content">
                        ...
                        <div className="swiper-slide">
                          <div className="location-card">
                            ...
                            >
                              <img
                                src="assets/img/innerpages/package-dt-location-img4.jpg"
                                alt=""
                              />
                            </a>
                            <div className="location-content">
                        ...
                        <div className="swiper-slide">
                          <div className="location-card">
                            ...
                            >
                              <img
                                src="assets/img/innerpages/package-dt-location-img5.jpg"
                                alt=""
                              />
                            </a>
                            <div className="location-content">
                  ...
                  <div className="highlights-wrap">
                    <ul className="items-list">
                      ...
                      <li>
                        ...
                        Opéra Garnier – Visit the stunning opera house that
                      ...
                      <li>
                        ...
                        Sunset Dinner Cruise on the Seine – Romantic fine dining
                        on the river.
                      </li>
                    </ul>
                  </div>
                  ...
                  <ul className="itinerary-list">
                    <li className="single-itinerary">
                      ...
                      <div className="tour-plan-wrap">
                        <div
                          className="accordion accordion-flush"
                          id="accordionTourPlan"
                        >
                          <div className="accordion-item">
                            <div
                              className="accordion-header"
                              id="flush-headingTourPlanOne"
                            >
                              <div
                                className="accordion-button"
                                role="button"
                                data-bs-toggle="collapse"
                                data-bs-target="#flush-collapseTourPlanOne"
                                aria-expanded="false"
                                aria-controls="flush-collapseTourPlanOne"
                              >
                                <h6>
                                  <span>
                                    <svg
                            ...
                            <div
                              id="flush-collapseTourPlanOne"
                              className="accordion-collapse collapse show"
                              aria-labelledby="flush-headingTourPlanOne"
                            >
                              <div className="accordion-body">
                                The Eiffel Tower is the heart of Paris and
                                offers a variety of exciting activities for
                                visitors. As like, climb the Eiffel Tower, take
                                the elevator to the summit, sunset & night view,
                                picnic at champ de mars & bike tour around the
                                Eiffel Tower.
                                <ul className="facilities-list">
                                  <li>
                                    <div className="single-item">
                                      <div className="facilities-title">
                                        ...
                                        >
                                          <g>
                                            <path d="M7.91983 0.380625C7.41233 -0.126875 6.58983 -0.126875 6.08233 0.380625L0.382578 6.08125C-0.124922 6.58875 -0.124922 7.41038 0.382578 7.917L6.08408 13.6185C6.59158 14.126 7.4132 14.126 7.91983 13.6185L13.6213 7.917C14.1288 7.4095 14.1288 6.58787 13.6213 6.08125L7.91983 0.380625ZM9.18245 4.54738L10.0697 5.51512L7.65733 7.72625V10.5H6.34483V7.72625L3.93245 5.51512L4.8197 4.54738L7.00108 6.54762L9.18245 4.54738Z" />
                                          </g>
                                        </svg>
                                        <h6>
                                          <span>Transport</span>
                                  ...
                                  <li>
                                    <div className="single-item">
                                      ...
                                      Climb the Eiffel Tower, Sunset & night
                                      view, Bike tour.
                                    </div>
                                  </li>
                                  <li>
                          ...
                          <div className="accordion-item">
                            <div
                              className="accordion-header"
                              id="flush-headingTourPlanTwo"
                            >
                              <div
                                className="accordion-button collapsed"
                                role="button"
                                data-bs-toggle="collapse"
                                data-bs-target="#flush-collapseTourPlanTwo"
                                aria-expanded="false"
                                aria-controls="flush-collapseTourPlanTwo"
                              >
                                <h6>
                                  <span>
                                    <svg
                            ...
                            <div
                              id="flush-collapseTourPlanTwo"
                              className="accordion-collapse collapse"
                              aria-labelledby="flush-headingTourPlanTwo"
                            >
                              <div className="accordion-body">
                                The Eiffel Tower is the heart of Paris and
                                offers a variety of exciting activities for
                          ...
                          <div className="accordion-item">
                            <div
                              className="accordion-header"
                              id="flush-headingTourPlanThree"
                            >
                              <div
                                className="accordion-button collapsed"
                                role="button"
                                data-bs-toggle="collapse"
                                data-bs-target="#flush-collapseTourPlanThree"
                                aria-expanded="false"
                                aria-controls="flush-collapseTourPlanThree"
                              >
                                <h6>
                                  <span>
                                    <svg
                            ...
                            <div
                              id="flush-collapseTourPlanThree"
                              className="accordion-collapse collapse"
                              aria-labelledby="flush-headingTourPlanThree"
                            >
                              <div className="accordion-body">
                                The Eiffel Tower is the heart of Paris and
                                offers a variety of exciting activities for
                    ...
                    <li className="single-itinerary">
                      ...
                      <div className="tour-plan-wrap">
                        <div
                          className="accordion accordion-flush"
                          id="accordionTourPlan2"
                        >
                          <div className="accordion-item">
                            <div
                              className="accordion-header"
                              id="flush-headingTourPlanFour"
                            >
                              <div
                                className="accordion-button collapsed"
                                role="button"
                                data-bs-toggle="collapse"
                                data-bs-target="#flush-collapseTourPlanFour"
                                aria-expanded="false"
                                aria-controls="flush-collapseTourPlanFour"
                              >
                                <h6>
                                  <span>
                                    <svg
                            ...
                            <div
                              id="flush-collapseTourPlanFour"
                              className="accordion-collapse collapse"
                              aria-labelledby="flush-headingTourPlanFour"
                            >
                              <div className="accordion-body">
                                The Eiffel Tower is the heart of Paris and
                                offers a variety of exciting activities for
                          ...
                          <div className="accordion-item">
                            <div
                              className="accordion-header"
                              id="flush-headingTourPlanFive"
                            >
                              <div
                                className="accordion-button collapsed"
                                role="button"
                                data-bs-toggle="collapse"
                                data-bs-target="#flush-collapseTourPlanFive"
                                aria-expanded="false"
                                aria-controls="flush-collapseTourPlanFive"
                              >
                                <h6>
                                  <span>
                                    <svg
                            ...
                            <div
                              id="flush-collapseTourPlanFive"
                              className="accordion-collapse collapse"
                              aria-labelledby="flush-headingTourPlanFive"
                            >
                              <div className="accordion-body">
                                The Eiffel Tower is the heart of Paris and
                                offers a variety of exciting activities for
                      ...
                      <div className="single-feature-list">
                        ...
                        <ul className="items-list two">
                          <li>
                            ...
                            >
                              <g>
                                <path d="M15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15C11.866 15 15 11.866 15 8ZM16 8C16 12.4183 12.4183 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8Z" />
                ...
                >
                  <img
                    src="assets/img/innerpages/package-dt-brochure-download-img.png"
                    alt=""
                  />
                </a>
                ...
                <div className="customize-package-banner-wrap">
                  ...
                  <div className="counter-area">
                    <ul className="counter-img-grp">
                      <li>
                        <img
                          src="assets/img/home3/counter-people-img1.png"
                          alt=""
                        />
                      </li>
                      <li>
                        <img
                          src="assets/img/home3/counter-people-img2.png"
                          alt=""
                        />
                      </li>
                      <li>
                        <img
                          src="assets/img/home3/counter-people-img3.png"
                          alt=""
                        />
                      </li>
                    </ul>
                        ...
                        <div className="swiper package-card-img-slider">
                          <div className="swiper-wrapper">
                            ...
                            <div className="swiper-slide">
                              ...
                              >
                                <img
                                  src="assets/img/home1/tour-package-img11.jpg"
                                  alt=""
                                />
                              </a>
                            </div>
                  ...
                  <div className="swiper-slide">
                    <div className="package-card">
                      <div className="package-img-wrap">
                        ...
                        >
                          <img
                            src="assets/img/home1/tour-package-img3.jpg"
                            alt=""
                          />
                        </a>
                      </div>
                        ...
                        <div className="swiper package-card-img-slider">
                          <div className="swiper-wrapper">
                            ...
                            <div className="swiper-slide">
                              ...
                              >
                                <img
                                  src="assets/img/home1/tour-package-img14.jpg"
                                  alt=""
                                />
                              </a>
                            </div>
                  ...
                  <div className="swiper-slide">
                    <div className="package-card">
                      <div className="package-img-wrap">
                        ...
                        >
                          <img
                            src="assets/img/home1/tour-package-img5.jpg"
                            alt=""
                          />
                        </a>
                      </div>
